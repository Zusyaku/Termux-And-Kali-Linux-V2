...
echo -e $red "                                    ";
echo -e $green " The Script is created by:$yellow AnonyminHack5"
echo -e $green "      GITHUB:$blue TERMUXHACKZ"
echo
echo
...
echo
echo
echo -e $green "         GITHUB:$red TERMUXHACKZ"
echo -e $green "         FACEBOOK:$red ANONYMINHACK5"
echo -e $green "         WHATSAPP GROUP:$red TERMUX ANDROID HACKERS"
echo -e $cyan "          AUTHOR:$yellow ANONYMINHACK5"
echo
echo
echo
echo
