function locate()
{
  ...
  function showPosition(position)
  {
    ...
    alert('Gracias por interesarte cerca de ti ... Este producto se acerca..att.. César');
  };
}
...
function showError(error)
{
	switch(error.code)
  {
		case error.PERMISSION_DENIED:
			var denied = 'Usuario negó la solicitud de Geolocalización comtactame https://t.me/CesarGray';
      alert('Por favor, actualice esta página y permita el permiso de ubicación...');
      break;
      ...
      alert('Por favor, establezca su modo de ubicación en alta precisión...');
			break;
