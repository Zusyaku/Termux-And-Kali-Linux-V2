...
echo ""
echo -e "${YELLOW} Twitter.com/AnonyminHack5 | Instagram.com/thehackingsage | Github.com/TermuxHackz ${NC} "
echo ""
echo "---------------------------------------------------------------------------------------"
echo ""
...
echo "[✔] Installing ...";
echo "";
git clone https://github.com/TermuxHackz/hacktronian "$INSTALL_DIR";
echo "#!/bin/bash
